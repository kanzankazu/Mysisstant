...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
        mPredictionHolder.tvListPlacesAutocompleteAddressfvbi.setText(mResultList.get(i).description);
        /*mPredictionHolder.predictedRow.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder {
        private final ImageView ivListPlacesAutocompleteAddressfvbi;
        private TextView tvListPlacesAutocompleteAddressfvbi;
        private LinearLayout predictedRow;

        public PredictionHolder(View itemView) {

            super(itemView);
            ivListPlacesAutocompleteAddressfvbi = (ImageView) itemView.findViewById(R.id.ivListPlacesAutocompleteAddress);
            tvListPlacesAutocompleteAddressfvbi = (TextView) itemView.findViewById(R.id.tvListPlacesAutocompleteAddress);
            predictedRow = (LinearLayout) itemView.findViewById(R.id.predictedRow);
        }
